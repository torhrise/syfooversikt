...
describe('Personliste', () => {
  ...
  const personregister = {
    [fnr1]: { navn: 'Et navn', harSvartPaaMotebehov: true, skjermingskode: 'INGEN', markert: false },
    [fnr2]: { navn: 'Et annet navn', harSvartPaaMotebehov: false, skjermingskode: 'EGEN_ANSATT', markert: false },
  };
