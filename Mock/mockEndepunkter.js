...
const VEILEDER_NAVN = 'veilederNavn';
...
function mockForLokal(server) {
  ...
  server.get('/syfoveileder/api/veileder/:id', (req, res) => {
    res.setHeader('Content-Type', 'application/json');
    res.send(JSON.stringify(mockData[VEILEDER_NAVN]));
  });
}
